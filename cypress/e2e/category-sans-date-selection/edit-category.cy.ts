...
describe('Edit Category', () => {
  ...
  describe('admin', () => {
    ...
    it('should edit a new master category description', () => {
      ...
      cy.get('div#edit-category-modal-div').should('not.exist')
      cy.get('button#category-dropdown-20').should('be.visible').wait(500).click()
      cy.get('button#edit-category-btn').should('be.visible').wait(500).click()
      cy.get('div#edit-category-modal-div').should('be.visible')
